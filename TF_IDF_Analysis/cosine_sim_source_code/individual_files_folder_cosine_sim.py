...
# Function to calculate cosine similarities and write results to file for each file
def calculate_cosine_similarity(file_paths, phrase, output_file):
    with open(output_file, 'w') as f:
        for file_path in file_paths:
            # Initialize a list to hold processed responses from current file
            processed_responses = []

            # Process responses from current file
            ...
            # Write results to file for the current file
            f.write(f"Cosine Similarities for {file_path}:\n")
